...
counts <- Read10X_h5(filename = "C:\\Users\\rbr7\\scATAC\\Signac\\vignette_disjoint\\atac_v1_pbmc_10k_filtered_peak_bc_matrix.h5")

metadata <- read.csv(
  file = "C:\\Users\\rbr7\\scATAC\\Signac\\vignette_disjoint\\atac_v1_pbmc_10k_singlecell.csv",
  header = TRUE,
  row.names = 1
)
...
chrom_assay <- CreateChromatinAssay(
  ...
  sep = c(":", "-"),
  genome = 'hg19',
  fragments = 'C:\\Users\\rbr7\\scATAC\\Signac\\vignette_disjoint\\atac_v1_pbmc_10k_fragments.tsv.gz',
  min.cells = 10,
  min.features = 200
)
...
pbmc_rna <- readRDS("C:\\Users\\rbr7\\scATAC\\Signac\\vignette_disjoint\\pbmc_10k_v3.rds")
...
```
```{r}
pbmc <- readRDS("C:\\Users\\rbr7\\scATAC\\scARIA\\pbmc_atac_integrated.rds")
```
